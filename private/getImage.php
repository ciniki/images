...
function ciniki_images_getImage($ciniki, $tnid, $image_id, $version, $maxwidth, $maxheight) {
    ...
    if( $rc['stat'] != 'ok' ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.images.27', 'msg'=>'Unable to render image', 'err'=>$rc['err']));
    }
    if( !isset($rc['image']) ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.images.28', 'msg'=>'Unable to render image'));
    }
