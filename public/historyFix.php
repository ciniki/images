...
// -------
//
function ciniki_images_historyFix($ciniki) {
	//
	...
	$rc = ciniki_images_checkAccess($ciniki, $args['business_id'], 'ciniki.images.historyFix', 0, 0);
	if( $rc['stat'] != 'ok' ) {
		return $rc;
	}
	...
	//
	// Remove any entries with blank table_key, they are useless we don't know what they were attached to
	//
